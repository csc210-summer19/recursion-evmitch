import model.LinkedPriorityList.Node;
...
// Find the maximum value in this list using the element's compareTo method
	...
	public E get(int index) {
		...
		return gethelp(first, 0, index);
	}


	private E gethelp(Node ref, int startIndex, int stopIndex) {
		if (startIndex == stopIndex) {
		       return (E) ref;
		    }
		if (startIndex > stopIndex || ref == null) {
		      return null;
		    }
		return gethelp(ref.next, startIndex, stopIndex++);
	}
